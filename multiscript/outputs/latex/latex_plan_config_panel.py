...
from multiscript.outputs.latex.latex_plan_config_panel_generated import Ui_LaTeXPlanConfigPanel


class LaTeXPlanConfigPanel(ConfigWidget, Ui_LaTeXPlanConfigPanel):
